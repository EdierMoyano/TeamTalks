    ...
    <div class="menu-dashboard">
        ...
        <div class="menu">
            ...
            <div class="enlace">
                ...
                <a href="index.php" class="boton-menu">Usuarios Inactivos</a>
            </div>
            <div class="enlace">
    ...
    <div class="content">
        ...
        <table class="table3" border="2">
            ...
            $sql = $con->prepare("SELECT * FROM usuarios 
                                ...
                                WHERE estado.Id_estado = 2 AND roles.Id_rol > 1");
            $sql->execute();
            ...
            <tr>
                ...
                <td name = "del"><a  href="../registrousers/delete.php?accion=Eliminar&id=<?php echo $resu['Id_user'];?>&origen=usersinactivos" onclick="return confirm ('¿Quieres eliminar este usuario?')"><img src="../registrousers/styles_registro/delete.png" width=25 height= 25 alt=""></a></td>
