    ...
    <div class="content">
        ...
        <table class="table3" border="2">
            ...
            <tr>
                ...
                <td name = "del"><a  href="../registrousers/delete.php?accion=Eliminar&id=<?php echo $resu['Id_user'];?>&origen=usersactivos" onclick="return confirm ('¿Quieres eliminar este usuario?')"><img src="../registrousers/styles_registro/delete.png" width=25 height= 25 alt=""></a></td>
